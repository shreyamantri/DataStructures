...
public class ArrayDeque<T> implements Deque<T> {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Deque lldN) {

            if (lldN.size() != this.size()) {
                return false;
            }

            int counter = 0;
            while (counter < size) {
                if (!lldN.get(counter).equals(get(counter))) {
                    return false;
                }
                counter += 1;
            }
        ...
        /**
        else if (obj instanceof ArrayDeque arrdN) {

            if (arrdN.size() != this.size()) {
                return false;
            }

            int counter = 0;
            while (counter < size) {
                if (!arrdN.get(counter).equals(get(counter))) {
                    return false;
                }
                counter += 1;
            }
